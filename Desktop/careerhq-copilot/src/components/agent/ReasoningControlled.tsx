...
interface ReasoningControlledProps {
  initialReasoning?: string;
  resultText?: string;
}

export function ReasoningControlled({
  initialReasoning = `Here's how I calculated the result:
1. Take the base number 2
2. Calculate 2^8 = 2×2×2×2×2×2×2×2
3. Result is 256`,
  resultText = "The result of the calculation is 256."
}: ReasoningControlledProps) {
  const [isOpen, setIsOpen] = useState(false);
  const [reasoningText, setReasoningText] = useState(initialReasoning);
